...
class Donut:
    ...
    def taste_of_donut(self) -> str:
        """
        Метод для обозначения вкуса пончика.
        :return: возвращает название вкуса пончика
        """
        pass
...
if __name__ == "__main__":
    bilding_1 = Bilding(4, 'Кирпич')
    book_1 = Book(200, 'Проза')
    donut_1 = Donut('Красный', 20)
